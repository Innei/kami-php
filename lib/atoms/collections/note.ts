...
interface NoteCollection {
  ...
  get(id: string | number): ModelWithLiked<NoteModel> | undefined
...
export const useNoteCollection = createCollection<
  ModelWithLiked<NoteModel>,
  NoteCollection
>('note', (setState, getState) => {
