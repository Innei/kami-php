...
export const XLogInfoBase: FC<{
  ...
  return (
    <div className={cn('my-6 text-sm', styles['root'])}>
      <div
        role="button"
        tabIndex={0}
        className="-mx-2 flex w-[100%+0.5rem] items-center justify-between rounded-lg p-2 text-left text-gray-900 transition-colors duration-300 hover:bg-zinc-100 dark:hover:bg-dark-200 md:rounded-xl"
        onClick={() => {
          setCollapse((c) => !c)
        }}
      >
